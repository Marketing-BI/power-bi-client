import type { PBIRefreshStatus, PBIRefreshType, PBIScheduleNotify } from './enums';
...
export type PBIRefreshSchedule = {
  notifyOption?: PBIScheduleNotify; //The notification option on termination of a scheduled refresh
